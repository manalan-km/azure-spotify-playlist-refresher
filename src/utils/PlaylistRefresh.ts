export class PlaylistRefresher {
    ...
    constructor(firstRefreshToken: string) {
        ...
        console.log('Refresh Token is ', firstRefreshToken)
        this.accessToken = ''
    ...
    async setNewAccessToken() {
        console.log('Setting new Access Token using Refresh Token')
        ...
        try {
            ...
            console.error(`Failed to set new access Token: ${err}`)
        }
    }
    ...
    async getTopTenSongsURIs(accessToken: string) {
        ...
        console.log("Retrieving Top Ten Songs' URIs")
    ...
    async refreshPlaylist() {
        ...
        const topSongsURIs: string[] =
            await this.getTopTenSongsURIs(accessToken)
